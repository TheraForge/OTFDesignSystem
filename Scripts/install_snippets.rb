...
def install_snippets
  puts 'Installing OTFDesignSystem code snippets...'
  ...
  # Process each .codesnippet file in the Snippets directory
  ...
  puts 'OTFDesignSystem code snippets installation complete!'
end
